...
--	备注：
-----------------------------------------------------------------
local M = class("PopupMsg1",PopupBase)
...
---------------------------------------------------------------------------------------------
function M:initNode()
	local node = cc.CSLoader:createNode("csb/popup/PopupMsg1.csb")
    self:addChild(node)
    ...
    self.buttons = {
        ...
        [POPUP_SELECT_EVENT_TYPE_NO] = nil,
        [POPUP_SELECT_EVENT_TYPE_OTHER] = nil,
    }
